    ...
    template: `
        <div class="h-full flex flex-col animate-fade-in">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <!-- Security Settings -->
                <div class="bg-surface-dark/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                    ...
                    <div class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <input type="password" v-model="currentPin" maxlength="4" placeholder="****" 
                                   class="w-full bg-black/20 border border-white/15 rounded-xl px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-primary/50 focus:bg-primary/5 transition-all font-mono text-center tracking-[0.5em]">
                        </div>

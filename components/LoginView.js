            ...
            <div class="bg-surface-dark/40 backdrop-blur-2xl border border-white/10 p-10 rounded-[2.5rem] w-[420px] text-center shadow-2xl relative z-10 flex flex-col gap-8 animate-scale-in">
                ...
                <div class="flex flex-col items-center">
                    <div class="w-24 h-24 mb-6 relative group">
                        ...
                        <div class="relative w-full h-full bg-gradient-to-br from-surface-light to-surface border border-white/10 rounded-3xl flex items-center justify-center shadow-2xl">
                ...
                <div class="space-y-6 w-full">
                    ...
                    <div class="h-20 bg-black/40 rounded-2xl flex items-center justify-center gap-4 border border-white/5 shadow-inner transition-all duration-300 relative overflow-hidden group"
                         :class="store.loginError ? 'border-red-500/50 shadow-[0_0_30px_rgba(239,68,68,0.2)] animate-shake' : 'hover:border-white/10'">
                ...
                <!-- Footer Info -->
                <div class="flex items-center justify-between px-4 pt-2 border-t border-white/5">
